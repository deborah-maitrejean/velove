...
<html lang="fr">
  <head>
    ...
    <meta name="keywords" content="louer un vélo lyon, louer un velo lyon, location vélo lyon, location velo lyon, carte location velo"/>
  ...
  <body>
    <div id="container">
      ...
      <header>
        ...
        <div>
          <h1>VéLove</h1>
          <p id="paragraphe1" title="titre du p1">Bienvenue sur VéLove, site interactif de location de vélos sur Lyon</p>
        </div>
        <!-- Menu principal -->
        <nav id="navigation">
          <!-- Dropdown menu -->
      ...
      <section id="slides-container">
        <ul id="slides">
          <li class="slide showing"><img src="img/slider/slide1.png" alt="Diapo 1 : séléctionnez une station sur la carte"></li>
          <li class="slide"><img src="img/slider/slide2.png" alt="Diapo 2 : un encart affiche désormais les données de la stations, il faut cliquer sur le bouton 'Réserver un vélo'"></li>
          <li class="slide"><img src="img/slider/slide3.png" alt="Diapo 3 : il faut signer dans le canvas, puis sur 'valider'"></li>
          <li class="slide"><img src="img/slider/slide4.png" alt="Diapo 4 : votre vélo est réservé pour 20 minutes, le décompte s'affiche en bas de page"></li>
        </ul>
        <div id="slide-btn">
      ...
      <figure id="legend">
        ...
        <div>
          <div>
            <img src="img/legend/station-open-and-available-bike.png" alt="La station est ouverte" class="legendImg">
            Station ouverte
          </div>
          <div>
            <img src="img/legend/no-available-bikes.png" alt="Pas de vélo disponible dans cette station" class="legendImg">
      ...
      <section id="timerSection">
        <div id="timer">
          ...
          <p id="pTimer">Votre vélo est réservé pour <span id="minutes"></span> minute(s) et <span id="secondes"></span> seconde(s).</p>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCXCOXAeVTGt274MyIK9IngR7bUyiku0pY&callback=VelovMap.init" async defer></script>
